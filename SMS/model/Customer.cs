namespace SMS.model
{
    public class Customer : User
    {
        ...
        public Customer(int id, string firstName, string lastName, string staffId, string email, string phoneNumber, int pin, string address, double wallet) : base(id, firstName, lastName, staffId, email, phoneNumber, pin)
        {
            Address = address;
            Wallet = wallet;
        }
